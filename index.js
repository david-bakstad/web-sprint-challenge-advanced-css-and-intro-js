...
artists[9] = "Vincent Van Gough";

console.log(artitsts[9])
...
function addArtist(artists){
    ...
    artist.push(id = "Id: 20"; name = "Name: David Bakstad"; years = "Years: 1983 - Current"; genre = "Genre: Web Design"; nationality = "Nationality: `Merica"; bio = "David is a 21st century inhabitant that will probably make it on a list like this somday because of his creativity.");
      console.log(artists)
  }
